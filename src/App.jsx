...
const FALLBACK_LETTERS = [
  // ✨ Open Heart (8)
  { message: "I thought about you today, whoever you are. I hope something small and good finds you. 💛", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 1).toISOString(), theme: "open" },
  { message: "You don't have to be okay today. You just have to be here. That's enough. 💛", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 2).toISOString(), theme: "open" },
  { message: "Someone out there is rooting for you without you even knowing it. Today that someone is me. 💛", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 3).toISOString(), theme: "open" },
  { message: "Nobody has it as together as it looks. You're doing better than you think. 💛", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 4).toISOString(), theme: "open" },
  { message: "This letter has no agenda. Just warmth, sent your way, from a stranger who hopes you're well. 💛", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 5).toISOString(), theme: "open" },
  { message: "The fact that you exist, right now, reading this, is quietly extraordinary. I mean that. 💛", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 6).toISOString(), theme: "open" },
  { message: "I don't know your name but I hope today is gentler than yesterday was. 💛", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 7).toISOString(), theme: "open" },
  { message: "You are someone's favourite part of a story they haven't told yet. 💛", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 8).toISOString(), theme: "open" },

  // 🌅 Hope (8)
  { message: "Tomorrow is genuinely unwritten. That used to scare me. Now I think it's the best news there is. 🌅", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 1).toISOString(), theme: "hope" },
  { message: "Something good is still coming. It hasn't arrived yet, but it's on its way to you. 🌅", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 2).toISOString(), theme: "hope" },
  { message: "Rest is not giving up. It's how you survive long enough to see what comes next. 🌅", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 3).toISOString(), theme: "hope" },
  { message: "The version of you from five years ago would be quietly amazed at who you've become. 🌅", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 4).toISOString(), theme: "hope" },
  { message: "Hope isn't naive. It's brave. It chooses to believe in good things anyway. So do you. 🌅", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 5).toISOString(), theme: "hope" },
  { message: "Even slow progress is still progress. Even a small step forward still counts. 🌅", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 6).toISOString(), theme: "hope" },
  { message: "I hope you get a morning soon where the light is soft and you have nowhere to be yet. 🌅", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 7).toISOString(), theme: "hope" },
  { message: "Things that feel permanent rarely are. The hard season you're in has an end, even if you can't see it. 🌅", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 8).toISOString(), theme: "hope" },

  // 🦁 Courage (8)
  { message: "Doing the scary thing with shaking hands still counts as brave. Maybe more so. 🦁", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 1).toISOString(), theme: "courage" },
  { message: "You've already survived every hard day you thought you couldn't. That record is yours. 🦁", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 2).toISOString(), theme: "courage" },
  { message: "The thing you're afraid to start is afraid of what you'll do once you do. Start anyway. 🦁", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 3).toISOString(), theme: "courage" },
  { message: "Asking for help is one of the bravest things a person can do. I hope you know that. 🦁", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 4).toISOString(), theme: "courage" },
  { message: "Whatever hard thing is in front of you today, you have more in you than you realise. 🦁", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 5).toISOString(), theme: "courage" },
  { message: "Courage doesn't always roar. Sometimes it's just deciding to try one more time. 🦁", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 6).toISOString(), theme: "courage" },
  { message: "You are allowed to be scared and still go. Fear and courage live in the same chest. 🦁", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 7).toISOString(), theme: "courage" },
  { message: "I see you holding it together when everything wants to fall apart. That takes real strength. 🦁", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 8).toISOString(), theme: "courage" },

  // 🌸 Gratitude (8)
  { message: "I'm grateful for the small quiet kindnesses nobody sees. Yours included. 🌸", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 1).toISOString(), theme: "gratitude" },
  { message: "Someone is carrying a good memory of you right now that you've completely forgotten about. 🌸", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 2).toISOString(), theme: "gratitude" },
  { message: "The small ways you show up for people ripple further than you'll ever know. Thank you. 🌸", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 3).toISOString(), theme: "gratitude" },
  { message: "I'm grateful we both exist, at the same time, on this spinning rock. What are the odds. 🌸", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 4).toISOString(), theme: "gratitude" },
  { message: "Thank you for the kindness you gave someone when you were tired and gave it anyway. 🌸", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 5).toISOString(), theme: "gratitude" },
  { message: "You make the world a little warmer just by being in it. That's worth saying out loud. 🌸", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 6).toISOString(), theme: "gratitude" },
  { message: "Grateful for quiet moments and the people who make them feel safe. I hope you have those. 🌸", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 7).toISOString(), theme: "gratitude" },
  { message: "The world is better for the care you put into it, even when no one says so. 🌸", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 8).toISOString(), theme: "gratitude" },

  // 🌠 Wish Upon a Star (8)
  { message: "I wish you one dream that surprises you by actually coming true. 🌠", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 1).toISOString(), theme: "stardust" },
  { message: "The dream you haven't told anyone about yet deserves a little more room to breathe. 🌠", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 2).toISOString(), theme: "stardust" },
  { message: "I wish you the courage to want what you actually want, not what makes sense on paper. 🌠", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 3).toISOString(), theme: "stardust" },
  { message: "You are made of the same stuff as stars. That is not a metaphor. It is just true. 🌠", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 4).toISOString(), theme: "stardust" },
  { message: "I wish you a door that opens to exactly the life you were hoping for. 🌠", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 5).toISOString(), theme: "stardust" },
  { message: "May something beautiful find you this week when you aren't even looking for it. 🌠", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 6).toISOString(), theme: "stardust" },
  { message: "I wish you a moment of pure joy with nothing attached to it, no reason needed. 🌠", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 7).toISOString(), theme: "stardust" },
  { message: "Your story isn't finished. The best chapters sometimes start without warning. 🌠", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 8).toISOString(), theme: "stardust" },

  // 🕊️ Healing (8)
  { message: "Some days healing looks like making breakfast and that is more than enough. 🕊️", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 1).toISOString(), theme: "healing" },
  { message: "You are allowed to still be recovering. There is no deadline on getting better. 🕊️", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 2).toISOString(), theme: "healing" },
  { message: "Night makes everything heavier. It lies. Tomorrow morning will weigh less. 🕊️", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 3).toISOString(), theme: "healing" },
  { message: "Be as gentle with yourself as you would be with someone you love. You deserve that too. 🕊️", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 4).toISOString(), theme: "healing" },
  { message: "Grief and growth can live in the same body at the same time. You don't have to choose. 🕊️", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 5).toISOString(), theme: "healing" },
  { message: "Soft days are allowed. Rest is not surrender. Please be kind to yourself today. 🕊️", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 6).toISOString(), theme: "healing" },
  { message: "Whatever you're carrying right now, I hope it gets lighter soon. You've held it long enough. 🕊️", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 7).toISOString(), theme: "healing" },
  { message: "Healing isn't linear and it isn't pretty. But it is happening, even on the days it doesn't feel like it. 🕊️", color_id: "amber", accessory_id: "none", created_at: new Date(Date.now() - 86400000 * 8).toISOString(), theme: "healing" },
];
...
function getUnseenFallback() {
  ...
  // If all fallbacks seen, return null — no more fallbacks
...
async function fetchRandomLetter(excludeSent = [], seenReceived = []) {
  ...
  // Only use fallback if DB is truly empty
  ...
  // Prefer unseen, but if all seen just cycle through real letters again
...
async function fetchTodaySentCount() {
  try {
    ...
    const r = await fetch(`${SUPABASE_URL}/rest/v1/letters?select=id&created_at=gte.${today}T00:00:00`, {
      headers: { "apikey": SUPABASE_ANON_KEY, "Authorization": `Bearer ${SUPABASE_ANON_KEY}`, "Prefer": "count=exact" },
    });
    const count = parseInt(r.headers.get("content-range")?.split("/")[1] || "0");
    return isNaN(count) ? 0 : count;
            ...
            return (
              <div key={i} style={{ background: "rgba(255,140,20,0.05)", border: `1px solid ${col.glow.replace("0.9","0.2")}`, borderRadius: 16, padding: "18px 22px", position: "relative", overflow: "hidden" }}>
                ...
                <p style={{ fontFamily: "'Georgia',serif", color: "rgba(255,220,140,0.75)", fontSize: "0.88rem", lineHeight: 1.7, margin: 0 }}>
                  {expandedIndex === i ? letter.message : (letter.message.length > 160 ? letter.message.slice(0,160)+"…" : letter.message)}
                </p>
                {letter.message.length > 160 && (
                  <button onClick={() => setExpandedIndex(expandedIndex === i ? null : i)}
                    style={{ background:"none", border:"none", color:"rgba(255,160,60,0.45)", fontFamily:"'Georgia',serif", fontStyle:"italic", fontSize:"0.75rem", cursor:"pointer", padding:"4px 0", marginTop:4 }}
                    onMouseEnter={e => e.currentTarget.style.color="rgba(255,180,60,0.85)"}
                    onMouseLeave={e => e.currentTarget.style.color="rgba(255,160,60,0.45)"}>
                    {expandedIndex === i ? "↑ Show less" : "↓ Read full letter"}
                  </button>
                )}
                {(() => {
...
function ReceiveScreen({ onBack, onWrite, sound, onStart, onDone }) {
  ...
  const loadLetter = useCallback(async () => {
    ...
    // If no letters in DB, use a fallback letter (only if unseen ones remain)
    if (!data) {
